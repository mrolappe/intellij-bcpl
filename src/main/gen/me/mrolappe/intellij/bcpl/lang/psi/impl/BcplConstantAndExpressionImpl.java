...
public class BcplConstantAndExpressionImpl extends ASTWrapperPsiElement implements BcplConstantAndExpression {

  public BcplConstantAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BcplVisitor visitor) {
    visitor.visitConstantAndExpression(this);
  }
  ...
  public BcplConstantShiftExpression getConstantShiftExpression() {
    return findNotNullChildByClass(BcplConstantShiftExpression.class);
  }
