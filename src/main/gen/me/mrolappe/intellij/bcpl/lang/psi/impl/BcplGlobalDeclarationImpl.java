...
public class BcplGlobalDeclarationImpl extends ASTWrapperPsiElement implements BcplGlobalDeclaration {

  public BcplGlobalDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public BcplGlobalList getGlobalList() {
    return findNotNullChildByClass(BcplGlobalList.class);
  }
