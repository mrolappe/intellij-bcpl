...
public class BcplGetDirectiveImpl extends ASTWrapperPsiElement implements BcplGetDirective {

  public BcplGetDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getStringConstant() {
    return findNotNullChildByType(STRING_CONSTANT);
  }
