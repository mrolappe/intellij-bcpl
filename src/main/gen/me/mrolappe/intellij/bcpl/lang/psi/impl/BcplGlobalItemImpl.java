...
public class BcplGlobalItemImpl extends ASTWrapperPsiElement implements BcplGlobalItem {

  public BcplGlobalItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BcplVisitor visitor) {
    visitor.visitGlobalItem(this);
  }
