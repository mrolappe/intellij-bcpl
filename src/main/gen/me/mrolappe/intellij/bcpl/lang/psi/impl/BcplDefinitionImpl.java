...
public class BcplDefinitionImpl extends ASTWrapperPsiElement implements BcplDefinition {

  public BcplDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public BcplSimpleDefinition getSimpleDefinition() {
    return findChildByClass(BcplSimpleDefinition.class);
  }
