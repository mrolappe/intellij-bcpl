...
public class BcplStaticDeclarationImpl extends ASTWrapperPsiElement implements BcplStaticDeclaration {

  public BcplStaticDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
